...
const PercentageCalculator = () => {
  ...
  >("percentage");
  const [value1, setValue1] = useState<string>("50");
  const [value2, setValue2] = useState<string>("100");
  const [result, setResult] = useState<string>("");
  const [animateResult, setAnimateResult] = useState(false);

  // Calculate result automatically on component mount and when values change
  useEffect(() => {
    calculateResult();
      ...
      <div className="flex-grow pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-3xl">
          <div className="glass-panel glass-panel-dark rounded-2xl overflow-hidden">
            ...
            <div className="p-6">
              <div className="mb-6">
                <h2 className="text-lg font-medium mb-4">How to Use in Your Blog</h2>
                <p className="text-foreground/70 mb-4">
                  Calculate percentages quickly for your blog content. Use this tool to determine metrics, 
                  growth rates, or create engaging statistical content for your readers.
                </p>
              ...
              {result && (
                ...
                >
                  ...
                  <p className="mt-4 text-sm text-foreground/70">
                    You can copy this result and use it in your blog post.
                  </p>
                </div>
              )}
            </div>
