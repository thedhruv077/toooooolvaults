...
export function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`flex items-center justify-center w-8 h-8 rounded-full glass-panel glass-panel-dark transition-transform duration-300 hover:scale-110 active:scale-95 ${className}`}
