...
import { Menu, X, Calculator, Grid, Sparkles, CheckCircle2 } from "lucide-react";
          ...
          <div className="flex items-center gap-2">
            <Link to="/" className="text-xl font-bold flex items-center group relative">
              ...
              <span className="relative text-foreground font-medium flex items-center z-10">
                ...
                <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-blue-600 bg-clip-text text-transparent font-bold tracking-tight">[𝙩𝘰𝘰Ꙇ𝙫𝕒𝙪𝙡𝙩𝙨]</span>
              </span>
            </Link>
